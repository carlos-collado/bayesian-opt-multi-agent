...
# PARAMETERS
# ------------------------
max_blackbox = np.array([4778.88039049, 1936.98985589, 3058.12593417])
...
labels_legend = ['Off-peak: 21:00-08:00', 'Peak: 16:00-21:00', 'Normal: 08:00-16:00']
...
axs[0,0].set_title("Objective - Discomfort")
axs[0,0].set_xlabel("Iteration")
axs[0,0].set_ylabel("Discomfort Level")
...
axs[0,1].set_title("Black-box Constraints - Max Welec")
axs[0,1].set_xlabel("Iteration")
axs[0,1].set_ylabel("Welec Value")
...
axs[1,0].set_title("Change of Lambda over Iterations")
